...
class TestInstance(TestBase.TestBase):
    ...
    def initialize(self):
        ...
        self.identify_ctrl_data = self.identify.controller_data(identify_ctrl_buffer.buff, verbose=False)
        ...
        identify_ns_buffer = self.drive.identify_namespace()
        self.identify_ns_data = self.identify.namespace_data(identify_ns_buffer.buff, verbose=False)
